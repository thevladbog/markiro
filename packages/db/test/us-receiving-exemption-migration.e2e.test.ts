...
const evidenceUrl = "https://例え.テスト/Ä";
const reason = "  Receipt-specific rationale  ";
const receipt = { evidenceUrl, tlcHandling: "assign_if_missing", proposedTlc: "=Case/Ä-001" };
type Path = "ordinary" | "preserved" | "assigned";
...
type Specimen = Awaited<ReturnType<typeof seed>>;
function firstItem(c: Specimen) {
