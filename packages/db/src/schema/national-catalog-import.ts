...
export const nationalCatalogImportImages = pgTable(
  "national_catalog_import_images",
  {
    ...
    preparationActorId: text("preparation_actor_id").references(() => user.id),
...
export const nationalCatalogProductLinks = pgTable(
  "national_catalog_product_links",
  {
    ...
    reviewedPhoto: jsonb("reviewed_photo"),
    reviewedProjection: jsonb("reviewed_projection"),
    observedProjection: jsonb("observed_projection"),
    refreshCheckpoint: jsonb("refresh_checkpoint"),
    refreshErrorCode: text("refresh_error_code"),
