...
ALTER TABLE "device_grant_configurations" ADD CONSTRAINT "device_grant_configurations_activation_fk" FOREIGN KEY ("tenant_id","activation_id") REFERENCES "public"."offline_grant_device_activations"("tenant_id","id") ON DELETE no action ON UPDATE no action NOT VALID;
