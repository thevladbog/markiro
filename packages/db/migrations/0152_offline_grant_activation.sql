...
CREATE TABLE "offline_grant_activation_preparations" (
	...
	CONSTRAINT "offline_grant_activation_state_check" CHECK ("offline_grant_activation_preparations"."state" in ('prepared','confirmed','cancelled','needs_review') and
        ...
        or ("offline_grant_activation_preparations"."state" = 'cancelled' and "offline_grant_activation_preparations"."rollout_policy_id" is null and "offline_grant_activation_preparations"."confirm_request_id" is null and "offline_grant_activation_preparations"."confirm_request_hash" is null and "offline_grant_activation_preparations"."confirm_response" is null and "offline_grant_activation_preparations"."confirmed_by_platform_user_id" is null and "offline_grant_activation_preparations"."confirmed_at" is null and "offline_grant_activation_preparations"."cancel_request_id" is not null and "offline_grant_activation_preparations"."cancel_request_hash" is not null and "offline_grant_activation_preparations"."cancel_response" is not null and "offline_grant_activation_preparations"."cancelled_by_platform_user_id" is not null and "offline_grant_activation_preparations"."cancelled_at" is not null and "offline_grant_activation_preparations"."cancellation_reason" is not null))),
