...
CREATE UNIQUE INDEX "device_grant_configurations_tenant_id_uq_idx" ON "device_grant_configurations" USING btree ("tenant_id","id");--> statement-breakpoint
ALTER TABLE "device_grant_configurations" ADD CONSTRAINT "device_grant_configurations_tenant_id_uq" UNIQUE USING INDEX "device_grant_configurations_tenant_id_uq_idx";--> statement-breakpoint
