    ...
    sections: [
      {
        ...
        blocks: [
          ...
          {
            kind: "paragraph",
            text: "Политика действует для публичного сайта, формы запроса демонстрации и тех случаев, когда Маркиро (англ. — Markiro) самостоятельно определяет цели обработки. Отношения по данным сотрудников тенанта отдельно описаны в разделе 12.",
          },
        ],
      },
      {
        ...
        blocks: [
          {
            ...
            items: [
              ...
              },
              {
                term: "Тенант",
                detail:
                  "изолированная организация-заказчик в Маркиро, самостоятельно определяющая цели работы с данными своих работников и иных лиц.",
              },
            ],
          },
          {
      ...
      },
      {
        ...
        blocks: [
          {
            kind: "paragraph",
            text: "Субъектами являются посетители сайта и представители организаций, которые направляют запрос на демонстрацию, а также пользователи платформы в тех случаях, когда Маркиро выступает самостоятельным оператором.",
          },
          {
            kind: "paragraph",
        ...
        blocks: [
          {
            ...
            items: [
              ...
              "организация демонстрации Маркиро;",
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            kind: "paragraph",
            text: "Маркиро в этой части обрабатывает данные по документированному поручению тенанта и отвечает за соблюдение инструкции, конфиденциальность, безопасность, контроль привлеченных обработчиков, сообщение об инцидентах, содействие по запросам и возврат либо удаление данных. Для собственных отдельно определенных целей Маркиро действует как самостоятельный оператор.",
          },
        ],
      },
      {
        ...
        blocks: [
          {
            kind: "paragraph",
            text: "Код документа — MKR-PD-01, редакция — 2026.08/01, дата вступления в силу — 15.08.2026. Новая редакция публикуется как отдельная версия с собственной датой и связью с заменяемым документом.",
          },
          {
            kind: "paragraph",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            kind: "paragraph",
            text: "Document code: MKR-PD-01; revision: 2026.08/01; effective date: 15 August 2026. A replacement is published as a distinct revision with its own date and supersession link.",
          },
          {
            kind: "paragraph",
