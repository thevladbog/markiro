      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            kind: "callout",
            tone: "warning",
            text: "«Аннулировать короб» — необратимое действие: обратного исправления для него нет, и кабинет не переспрашивает — короб аннулируется сразу после указания причины. Аннулированный короб навсегда остаётся блокировкой закрытия: такую инвентаризацию можно будет закрыть только аварийно, а сам короб и его состав не попадут в итоговые документы по коробам. Сверяйте номер короба до сохранения.",
          },
          {
            kind: "step",
