      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            kind: "callout",
            tone: "warning",
            text: "Две блокировки снять нельзя. Аннулированные короба остаются блокировкой навсегда: обратного действия у аннулирования нет. Обязательные расхождения без решения — это уже зафиксированные результаты по кодам: неизвестный, не учитываемый или отменённый скан остаётся в результате, и исправления его не убирают. Из расхождений исправлением закрывается только расхождение по дате производства, да и то у кода, который не лежит в коробе: у кода в коробе кнопки «Изменить дату» нет. Если осталась хотя бы одна такая блокировка, задание закрывается только аварийно.",
          },
          {
            kind: "step",
        ...
        blocks: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                detail:
                  "Сначала дождитесь синхронизации всех событий: несинхронизированные сканы не учтены в счётчиках. Из оставшихся расхождений исправлением закрывается только расхождение по дате производства; неизвестные и не учитываемые коды остаются в зафиксированном результате, и такое задание закрывается аварийно (см. раздел 4).",
              },
              {
