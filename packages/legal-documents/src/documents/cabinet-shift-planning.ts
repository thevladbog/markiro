      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: "Нажмите «Запланировать смену» — откроется «Новая смена». Форма разбита на разделы «Продукт и режим», «Планирование», «Назначение производства», «Шаблоны» и — только для агрегации — «Агрегация». Если для смены включена печать дубликата, вместо «Шаблонов» показывается раздел «Печать дубликата» (раздел 8).",
