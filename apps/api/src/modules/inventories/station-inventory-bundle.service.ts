  ...
  private selectStoredManifestFacts(executor: InventoryExecutor) {
    return executor
      .select({
        ...
        authoritativeProductName: schema.inventorySnapshots.productName,
        authoritativeLineName: schema.inventorySnapshots.lineName,
        authoritativeBoxCapacity: schema.inventorySnapshots.boxCapacity,
