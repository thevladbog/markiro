...
const CUSTOMER_ROUTE_GROUPS: readonly {
...
}[] = [
  {
    ...
    routes: [
      ...
      "GET /chz-km-orders (ChzKmOrdersController.list)",
      "GET /chz-km-orders/:id (ChzKmOrdersController.get)",
      "GET /chz-km-orders/:id/issues/:issueId/codes (ChzKmOrdersController.issueCodes)",
      "GET /chz-km-orders/:id/issues/:issueId/file (ChzKmOrdersController.issueFile)",
      ...
      "GET /code-search/shifts/:shiftId/placards (CodeSearchController.shiftPlacards)",
      ...
      "GET /inventories/:id/chz-exports (ChzExportsController.getState)",
      ...
      "GET /products/:id/readiness (ProductRegulatoryController.getReadiness)",
      "GET /products/:id/regulatory-category-options (ProductRegulatoryController.getCategoryOptions)",
      "GET /products/:id/regulatory-profile (ProductRegulatoryController.getProfile)",
      "GET /products/:id/regulatory-proposals/:proposalId (ProductRegulatoryController.getProposal)",
  ...
  },
  {
    ...
    routes: [
      ...
      "PATCH /products/:id/regulatory-attributes (ProductRegulatoryController.updateAttributes)",
      ...
      "POST /chz-km-orders (ChzKmOrdersController.create)",
      "POST /chz-km-orders/:id/issues (ChzKmOrdersController.issue)",
      "POST /chz-km-orders/:id/retry (ChzKmOrdersController.retry)",
      ...
      "PUT /products/:id/egais-codes (ProductRegulatoryController.replaceEgaisCodes)",
...
const EXEMPTIONS: Readonly<Record<string, RouteExemption>> = {
  ...
  "PlatformGrantRollbackController.confirm": platform(
    "offline grant rollback confirmation requires the dedicated platform activation capability",
  ),
  "PlatformGrantRollbackController.cancel": platform(
    "offline grant rollback cancellation requires the dedicated platform activation capability",
  ),
