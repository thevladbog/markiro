...
class DeviceRecoveryMigrationTest {
    ...
    private fun database(name: String) = Room.databaseBuilder(context, HandheldDatabase::class.java, name)
        ...
        .addMigrations(MIGRATION_7_8, MIGRATION_8_9, MIGRATION_9_10, MIGRATION_10_11, MIGRATION_11_12, MIGRATION_12_13, MIGRATION_13_14, MIGRATION_14_15, MIGRATION_15_16).build()
