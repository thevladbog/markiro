...
export const STATION_CAPABILITIES = `subscription-state-v1,station-recovery-v1,replacement-boundary-v1,${PRODUCT_LABEL_PROTOCOL},${VALIDATION_REPROCESSING_PROTOCOL}`;
