...
| «Честный знак»    | Агент подписания для аутентификации в True API, шифрованное хранение токена, товарные группы, выгрузки статусов кодов, заказы КМ, шифрованный пул кодов, выгрузка и печать в кабинете |
