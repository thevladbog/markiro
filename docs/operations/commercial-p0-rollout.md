...
2. Apply additive migration `0127_commercial_terms.sql`. Keep existing nulls and frozen snapshots;
...
Migration 0127 is additive but loosens resource checks to permit zero and introduces nullable
