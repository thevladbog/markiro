...
| POST   | `/traceability/lots`                | `traceability.master_data.write`                                                                      | Manual/imported lot; duplicate per LOT-007 → 409 `LOT_DUPLICATE` with the existing id         |
