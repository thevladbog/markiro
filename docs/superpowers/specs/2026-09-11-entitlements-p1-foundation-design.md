...
Уточнение владельца продукта от 2026-09-12: публикация тарифов, дополнений и услуг по V3
не требует дополнительной lifecycle policy. Без неё сохраняются действующие правила
подписки и доступны КП и счета. Все четыре значения модулей тарифа остаются явными;
выбранная политика должна быть одобрена, а её ID/версия/hash входят в proof публикации.
Публикация не активирует новые ограничения P1; их готовность и переход остаются отдельным
этапом. Тестовые policy fixtures не являются
