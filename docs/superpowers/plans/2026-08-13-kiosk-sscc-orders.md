...
- Create: `packages/db/migrations/0037_kiosk_sscc_orders.sql`
...
```bash
git add packages/db/src/schema/platform.ts packages/db/src/schema/pickup.ts packages/db/migrations/0037_kiosk_sscc_orders.sql packages/db/migrations/meta/0037_snapshot.json packages/db/migrations/meta/_journal.json packages/db/test/schema.test.ts packages/db/test/pickup-schema.test.ts packages/db/test/runtime-migrate.test.ts
...
```bash
git diff -- packages/db/migrations/0037_kiosk_sscc_orders.sql
