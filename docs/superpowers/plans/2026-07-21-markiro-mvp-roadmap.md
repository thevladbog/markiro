...
| 03  | **Catalog, counterparties & shifts** (written: `2026-07-22-03-catalog-admin.md`)     | CRUD API + admin panel shell (`packages/ui` from handoff tokens, sidebar, RU/EN i18n, light/dark), product cards with GTIN owner auto-detection, shift planning                                                                                                          | 02                                                                  |
