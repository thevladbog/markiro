...
| 04  | **Label templates** (written: `2026-07-23-04-label-templates.md`)                                                | Domain: template model, ZPL/TSPL generation, Cyrillic canvas rasterization + font coverage check; admin: template library + WYSIWYG editor + preview                                                                                                                     | 03                                                                  |
