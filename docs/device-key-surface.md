...
| `conflicts`                                                                            | the manager's backstop for scans a station never learns it lost (see Task 06b-7) — a station has no business reading, let alone reviewing, another terminal's conflicts                                                                                    |
