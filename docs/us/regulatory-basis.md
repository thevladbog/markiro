...
from a U.S. attorney or food-safety consultant. Permitted and prohibited
...
specific template is not the only acceptable form, but for a case-ready P0 it
...
useful standard for exchanging event data and a possible post-filing adapter,
