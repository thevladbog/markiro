...
| Status    | Rules                                                                                |
| --------- | ------------------------------------------------------------------------------------ |
| draft     | May be changed; not included in case-ready export.                                   |
...
mappings. The P0 column reads "Yes" for filing-minimum fields, "If applicable" for
...
| Case-ready           | Sufficiently implemented and evidenced for inclusion in the working NIW package; not legal approval. |
| Filing freeze        | Point at which tagged release and evidence artifacts are locked for attorney review.                 |
| Synthetic demo       | Fictional, reproducible dataset containing no real confidential data.                                |
| P0/P1/P2             | Filing minimum / pre-filing strengthener / post-filing.                                              |
