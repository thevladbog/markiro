...
**Markiro U.S. Traceability** is a traceability readiness demonstrator for
...
workflows. It is built inside the existing product as a new area, not as a
separate product, and it must never claim to be more than that: it is not FDA
approved, not certified, and it does not guarantee compliance (see the wording
matrix below — it is binding for every string you draw).
...
| ----------------------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `RU_CHZ`                      | Every existing Russian tenant                              | Exactly today's product (briefs 03–08). Nothing from this series.                                                     | The whole Traceability area.                                                                                                      |
...
The profile is set once in Settings and is visible on every screen as a text
badge in the header (`US · FSMA 204`, `US · Generic`, nothing for RU).
...
- U.S. hosting, billing and payment stack; SOC 2 badges.
...
| 07  | Landing and outreach             | `/en/us-food-traceability/` page sections, video poster, outreach one-pager wording — all under the claims matrix                             |
...
## How the U.S. area coexists with the RU product

- One codebase, one design system, one navigation shell. The profile switch
  **hides** RU sections for U.S. tenants and hides the Traceability section
  for RU tenants. Hiding is a usability control; nothing is redesigned for
  either side.
