...
> the existing landing (`apps/landing`, Astro), plus a printable outreach kit. Desktop 1440 first,
...
> slice specs US-12 (landing, video, outreach) and US-11 (evidence: screenshots, ribbon, video).
...
same content, restated for print, becomes the outreach kit used in discovery calls, a specialist
review and requests for letters of interest.
...
customer data. Signed letters and memos never enter the repository.

| Deliverable                     | Content                                                                                                                                                                                                                        | Layout guidance                                                                                   |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| One-pager (PDF)                 | Problem (24-hour records, lot-level KDEs, small processors); what it does (three CTEs, TLC/source, plan, request, spreadsheet); what it is not (limitations verbatim); demo numbers; founder line; page + video links; contact | One side; three columns or a 2/3 + 1/3 split; the limitations block boxed, not footnoted          |
| Deck outline (8–10 slides)      | Context and rule timeline (dated, from regulatory-basis.md); who is affected; three-CTE flow; data model; demo walkthrough stills; evidence ladder; platform foundation; limitations; roadmap (P1/P2); the ask                 | Title + one idea per slide; stills with ribbon; limitations slide is mandatory, never an appendix |
...
| Letter-of-interest guidance     | What an authentic letter **must** contain and **must not** contain (below), plus a short request e-mail                                                                                                                        | Checklist style; two clearly separated lists                                                      |

**An authentic letter of interest must** be on the author's own letterhead with name, role and
organization; describe the author's own traceability problem in their words; say what they saw
(date of demo or call, version tag); name what interests them (a workflow or artifact); state an
intent to continue discussion, evaluate a pilot or give feedback; be dated and signed.

**It must not** contain a purchase commitment, price, contract or volume promise the author did
not make; any claim that the product is approved, certified or compliant; text drafted by us and
merely signed (we send the guidance and the one-pager, never a pre-written letter); confidential
data of the author's company.
...
- Letters of interest and the review memo, once obtained, are cited by id and hash in the evidence
